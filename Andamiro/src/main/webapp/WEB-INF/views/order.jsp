	...
	<div class="container">
		<div class="container"
			...
			<section style="float: left; width: 100%; text-align: center;">
				<div style="width: 100%">
					<table table class="table table dataTable" id="dataTable"
				...
				<div
					...
					<table class="table table dataTable" id="dataTable" cellspacing="0"
						role="grid">
						<colgroup>
							<col style="width: 5%"></col>
							<col style="width: 20%"></col>
				...
				<div>
					<table table class="table table-bordered dataTable" id="dataTable"
						width="100%" cellspacing="0" role="grid"
						aria-describedby="dataTable_info;">
						<colgroup>
						...
						<tr>
							...
							<th><input type="button" value="한줄 취소"
								class="btn btn-warning" style="width: 100%; height: 100%;"></th>
					...
					<article style="width: 50%; float: left;">
						<div style="width: 100%;" class="form-group">
							<table table class="table table-bordered dataTable"
								...
								<tbody>
									<tr role="row" class="odd">
										<td><lable class="col-xs-6 .col-sm-3">총 금액 : </lable></td>
					...
					<table table class="table table-bordered dataTable" id="dataTable"
						...
						<tbody>
							<tr style="border-collapse: collapse;">
								<th class="sorting_1"><input type="button" value="아메리카노"
							...
							<tr>
								<th class="sorting_1"><input type="button" value="1"
									class="btn btn-warning"></th>
								<th class="sorting_1"><input type="button" value="2"
									class="btn btn-warning"></th>
								<th class="sorting_1"><input type="button" value="3"
